 ...
 */
class GrpAnyOtherInfo extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            //[['queId', 'status', 'created_at', 'updated_at', 'created_uname', 'updated_uname', 'created_by', 'updated_by'], 'safe'],
                    [['comments','anyotherinfo','verifiedBy'],'safe'],
                    ['queId','unique'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'anyotherinfo'=>Yii::t('app','Any other information'),
            'verifiedBy'=>Yii::t('app','Verified By Acharya'),
