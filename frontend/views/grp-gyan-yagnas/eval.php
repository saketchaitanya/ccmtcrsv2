        ...
        <div class='panel-body'>
            <div class='panel panel-default'>
                <div class='panel-body'>
                                                            ...
                                                            'pluginEvents'=>[
                                                                ...
                                                                "touchspin.on.startupspin"=> 
                                                                        "function()
                                                                        {
                                                                            ...
                                                                            {
                                                                                var name = 'grpgyanyagnas-dataarray-'+i+'-elementmarks';
                    ...
                    <?php //$model->marks = (sizeof($model->dataArray) > 15) ? 15:sizeof($model->dataArray) ; ?>
                    <?= 
