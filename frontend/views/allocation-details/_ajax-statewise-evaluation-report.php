					...
					<?php foreach($codes as $code):?>
						<?php if($centreData[$code]['stateCode']==$stkey):?>
							<tr>
								...
								<td align='right'> <?= isset($allocations1[$code])? \Yii::$app->formatter->asCurrency($allocations1[$code]) : '' ?> </strong> </td>
								<?php if (isset($year2)): ?>
									<td align='right'> <?= isset($allocations2[$code])? \Yii::$app->formatter->asCurrency($allocations2[$code]) : '' ?> </strong> </td>
								<?php endif; ?>
								<td></td>
							</tr>
							<?php $count++ ?>
