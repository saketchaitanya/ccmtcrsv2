                ...
                <div class='panel-body'>
                    <div class="questionnaire-view">    
                        ...
                        <?php else: ?>
                            ...
                            <div class='panel panel-default'>
                                <div class= 'panel-body'>
                                    <h4><b>Any activity coming under "Prachar Work" <u>not mentioned in this questionnaire</u> taken up by your centre.</b></h4><hr/>       
                                    <!--- YOUR FIELDS HERE -->
                                                            ...
                                                            'pluginEvents'=>[
                                                                ...
                                                                "touchspin.on.startupspin"=> 
                                                                        "function()
                                                                        {
                                                                            ...
                                                                            {
                                                                                var name = 'grppracharwork-dataarray-'+i+'-elementmarks';
                    ...
                    <?php /*if($model->marks == 0) 
                        $model->marks = (sizeof($model->dataArray) > 5) ? 5:sizeof($model->dataArray) ;*/ ?>
