...
use frontend\models\GrpAcharyaClasses as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpAcharyaClassesController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpAcharyaClassesController';
   

   //change this according to the collection Name as specified in active record.
    private static $colName ='grpAcharyaClasses';
