...
use frontend\models\GrpPublications as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpPublicationsController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpPublicationsController';
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpPublications';
