 ...
 */
class GrpGeneralController extends QueController
{
    
    //change this according to the name of the class.
    private static $contName = 'GrpGeneralController';

    //change this according to the collection Name as specified in active record.
    private static $colName ='grpGeneral';
