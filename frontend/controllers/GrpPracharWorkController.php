...
use frontend\models\GrpPracharWork as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpPracharWorkController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpPracharWorkController';
   
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpPracharWork';
