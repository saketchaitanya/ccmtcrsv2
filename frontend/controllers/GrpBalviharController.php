...
use frontend\models\GrpBalvihar as QModel;
 ...
 */
class GrpBalviharController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpBalviharController';

    //change this according to the collection Name as specified in active record.
    private static $colName ='grpBalvihar';
    ...
    public function behaviors()
    {
        return [
            ...
            /*[
                    ...
                    'only' => ['next','previous','view','update','eval'],
            ...
            'access'=>[
                            ...
                            'only' => ['create', 'eval','view','view-eval'],
                            'rules' => 
                            [
                                [
                                    'allow' => true,
