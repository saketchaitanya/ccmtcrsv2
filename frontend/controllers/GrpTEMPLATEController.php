...
use frontend\models\GrpTEMPLATE as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GRPTEMPLATEController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpTEMPLATEController';
    //change this according to the collection Name as specified in active record.
    private static $colName ='grpTEMPLATECOLLECTIONNAME';
