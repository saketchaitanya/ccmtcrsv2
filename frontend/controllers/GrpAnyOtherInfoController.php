...
use frontend\models\GrpAnyOtherInfo as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpAnyOtherInfoController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpAnyOtherInfoController';
   
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpAnyOtherInfo';
