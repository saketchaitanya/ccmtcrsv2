...
use frontend\models\GrpVidyalaya as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpVidyalayaController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpVidyalayaController';
   
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpVidyalaya';
