...
use frontend\models\GrpFestivals as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpFestivalsController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpFestivalsController';
    
    //change this according to the collection Name as specified in active record.
    private static $colName ='grpFestivals';
