...
use frontend\models\GrpLiterary as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpLiteraryController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpLiteraryController';
   
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpLiterary';
