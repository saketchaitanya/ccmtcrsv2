...
use frontend\models\GrpGyanYagnas as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpGyanYagnasController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpGyanYagnasController';
   
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpGyanYagnas';
