...
use frontend\models\GrpSevaWork as QModel; //replace TEMPLATE  by the name of your class 
 ...
 */
class GrpSevaWorkController extends QueController
{
    
    //change TEMPLATE to according to the name of your class.
    private static $contName = 'GrpSevaWorkController';
   //change this according to the collection Name as specified in active record.
    private static $colName ='grpSevaWork';
